...
ModelUtil.clear
[model, ~] = mphopen('main_design_qc3.mph', 'model')
%%
...
tab_x_lambd_1 = [x0];
tab_y_lambd_1 = [y0];
tab_E_lambd_1 = linspace(0.15, 1, N_E_lambd_1);

kappa_1 = 1 * kappa_unit;
N_spec = 10;
